...
Note: This project uses `--legacy-peer-deps` to handle peer dependency conflicts. This is automatically configured via `.npmrc` file. If you encounter dependency conflicts, the installation will use legacy peer deps resolution automatically.
